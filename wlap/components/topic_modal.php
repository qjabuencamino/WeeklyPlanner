<div class="modal fade" id="topic_modal" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form method="POST">
            <div class="modal-body">
                ...
                <p class="small-text">
                    Topic
                    <textarea class="form-control normal-text" name="topic" placeholder="enter your topic"></textarea>
                </p>
            </div>
...
if(isset($_POST['add_topic'])){
    ...
    $sql = "INSERT INTO topic (subject_id,week,topic,type,user_id) VALUES ('$subject_id','$week','$topic','$type','$user_id')";
    $res = mysqli_query($conn,$sql);
    if($res){
